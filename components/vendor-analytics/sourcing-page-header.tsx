  ...
  return (
    <div className="mb-6">
      ...
      <div className="mb-2">
        ...
        <span style={breadcrumbTextStyle}>Sourcing Insights</span>
      </div>

      {/* Title and Action buttons - with updated page title typography */}
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 style={pageTitleStyle}>Your Sourcing Performance</h1>
          <p className="text-gray-600 mt-2" style={{fontFamily: '"Work Sans", sans-serif'}}>
            AI-powered insights from your recent submissions to help refine sourcing strategies and improve candidate quality
          </p>
        </div>
